...
for i in range(0,len(arrivals)):
  ...
  if (arrival < departure): 
    ...
    delay      = 0.0                        # no delay          */
  service      = 7.12 * FACTOR # services[i] #GetService(fp)
  wait         = delay + service
...
print("")
print("   x ....................... = {0:6.2f}".format(sum.service / departure))
print("   q ....................... = {0:6.2f}".format(sum.delay / departure))
print("   l ....................... = {0:6.2f}".format(sum.wait / departure))
