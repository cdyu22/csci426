...
/* ============== */
{
  ...
  double avgInterArrival = sum.interarrival / index;
  double avgService      = sum.service      / index;
  double avgDelay        = sum.delay        / index;
  double avgWait         = sum.wait         / index;
  ...
  printf("   average nbr in the node  l = %6.2f\n", sum.wait / departure);
  printf("   average nbr in the queue q = %6.2f\n", sum.delay / departure);
  printf("   average nbr in service   x = %6.2f\n", sum.service / departure);
